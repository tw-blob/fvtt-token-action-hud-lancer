...
export const DEFAULTS = {
    categories: [
        {
            nestId: 'pilot',
            id: 'pilot',
            name: game.i18n.localize('tokenActionHud.lancer.pilot'),
            subcategories: [
                {
                    nestId: 'pilot_skill-triggers',
                    id: 'skill-triggers',
                    name: game.i18n.localize('tokenActionHud.lancer.skillTriggers'),
                    type: 'system',
                ...
                },
                {
                    nestId: 'pilot_grit',
                    id: 'grit',
                    name: game.i18n.localize('tokenActionHud.lancer.grit'),
                    type: 'system',
                    hasDerivedSubcategories: false
                },
                {
                    nestId: 'pilot_talents',
                    id: 'talents',
                    name: game.i18n.localize('tokenActionHud.lancer.talents'),
                    type: 'system',
                    hasDerivedSubcategories: true
                },
                {
                    nestId: 'pilot_pilot-gear',
                    id: 'pilot-gear',
                    name: game.i18n.localize('tokenActionHud.lancer.gear'),
                    type: 'system',
                    hasDerivedSubcategories: false
                },
                {
                    nestId: 'pilot_pilot-weapons',
                    id: 'pilot-weapons',
                    name: game.i18n.localize('tokenActionHud.lancer.weapons'),
                    type: 'system',
                    hasDerivedSubcategories: false
                }
            ]
    ...
    subcategories: [
        { id: 'skill-triggers', name: game.i18n.localize('tokenActionHud.lancer.skillTriggers'), type: 'system', hasDerivedSubcategories: false },
        { id: 'grit', name: game.i18n.localize('tokenActionHud.lancer.grit'), type: 'system', hasDerivedSubcategories: false },
        { id: 'talents', name: game.i18n.localize('tokenActionHud.lancer.talents'), type: 'system', hasDerivedSubcategories: true },
        { id: 'pilot-gear', name: game.i18n.localize('tokenActionHud.lancer.gear'), hasDerivedSubcategories: false },
        { id: 'pilot-weapons', name: game.i18n.localize('tokenActionHud.lancer.weapons'), type: 'system', hasDerivedSubcategories: false }
